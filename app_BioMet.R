...
library(shinythemes)
library(cowplot)
library(imager) # had to download quartz to be able to run this library properly
library(naniar)
library(GGally)
...
setwd('~/Desktop/codes/Biomet/BioMet_shiny/')
  ...
  observeEvent(inputs(), {
    ...
    if (is.null(input$secfile) == F) { # IF STATEMENT FOR WHEN THRSTAG FILE IS MISSING
      if (length(input$secfile$name) == 1) {
        ...
        ProSecFile <- data_processing(SelectedData$sec_clean, '~/Desktop/codes/Biomet/BioMet_shiny/data/flux_variables.csv', 'Second')
        ...
        ProSecFile <- data_processing(CleanedData, '~/Desktop/codes/Biomet/BioMet_shiny/data/flux_variables.csv', 'Second')
    ...
    if (is.null(input$thrfile) == F) { # IF STATEMENT FOR WHEN THRSTAG FILE IS MISSING
      if (length(input$thrfile$name) == 1) {
        ...
        ProThrFile <- data_processing(SelectedData$thr_clean, '~/Desktop/codes/Biomet/BioMet_shiny/data/flux_variables.csv', 'Third')
        ...
        ProThrFile <- data_processing(ThrCleanedData, '~/Desktop/codes/Biomet/BioMet_shiny/data/flux_variables.csv', 'Third')
